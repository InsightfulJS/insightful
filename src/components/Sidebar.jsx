...
const Sidebar = () => {
	...
	return (
		<div className='relative w-[20%] h-full bg-slate-900 flex flex-col'>
			{/* Overlay Glow Effect */}
			<SidebarOverlay />
			...
			{/* Sidebar Content */}
			<div className='absolute w-full h-full flex flex-col justify-start items-start py-8 px-4 gap-12'>
				{/* Logo */}
				<div className='flex flex-row gap-2 justify-center items-center'>
					<FaRegLightbulb className='text-cyan-50 w-4 h-4' />
